package douglas.develop.auth.security.config;


import douglas.develop.auth.security.filter.JwtUsernameAndPasswordAuthenticationFilter;
...
public class SecurityCredencialsConfig extends SecurityTokenConfig {
    ...
    public SecurityCredencialsConfig(JwtConfiguration jwtConfiguration,
